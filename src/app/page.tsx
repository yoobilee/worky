  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col gap-2 flex-1 min-h-0 h-full w-full">
        ...
        >
          ...
          {!dataLoaded ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-3 py-6">
              ...
              <Link
                href="/todo"
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold transition-all bg-white text-[#6C63FF]"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 items-stretch flex-1 min-h-0">
        ...
        {/* 오늘의 팁 — 3티어 */}
        <div className="bg-slate-50 dark:bg-zinc-800/50 rounded-2xl p-4 flex flex-col overflow-hidden">
